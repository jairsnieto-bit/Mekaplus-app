...
import { guideAPI, senderAPI } from '../services/api';  // ✅ Agregar senderAPI
...
const CreateGuide = () => {
  ...
  useEffect(() => {
    const fetchSenders = async () => {
      try {
        // ✅ CAMBIO: Usar senderAPI.getActive() en lugar de guideAPI.getActive()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await guideAPI.create({
        ...formData,
        senderId: selectedSenderId  // ✅ Agregar senderId
      });
