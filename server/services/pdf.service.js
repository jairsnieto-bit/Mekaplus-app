        ...
        <div class="guide">
          ...
          <aside class="sidebar-vertical">
            <div class="sidebar-content">
              ...
              <!-- ✅ INFORMACIÓN FIJA SUPERIOR -->
              <div class="sidebar-fixed-info">
                <div class="fixed-text-line">Mekaplus express S.A.S NIT. 901505437-1</div>
                <div class="fixed-text-line">Principal: Cartagena Colombia Sec Víctor Blanco Mz.173.LT.10</div>
                
                            
              <div class="sidebar-text">
              <div class="fixed-text-line">REMITE</div>
                ...
                <div class="tables-grid">
                  <div class="property-box">
                    ...
                    <div class="options" style="padding: 0.01in 0;">
                      <label style="display: block; margin: 0.11in 0.09in;">☐ Casa</label>
                      <label style="display: block; margin: 0.11in 0.09in;">☐ Edificio</label>
                      <label style="display: block; margin: 0.11in 0.09in;">☐ Negocio</label>
                      <label style="display: block; margin: 0.11in 0.09in;">☐ Conjunto</label>
                    </div>
                  </div>
                  ...
                  <div class="floor-box">
                    <div class="vertical-label-small" style="padding-top: 0.03in;">PISO</div>
                      <div class="options" style="padding: 0.01in 0;">
                        <label style="display: block; margin: 0.06in 0;">☐ 1</label>
                        <label style="display: block; margin: 0.06in 0;">☐ 2</label>
                        <label style="display: block; margin: 0.06in 0;">☐ 3</label>
                        <label style="display: block; margin: 0.06in 0;">☐ 4</label>
                        <label style="display: block; margin: 0.06in 0;">☐ +4</label>
                      </div>
                  </div>
    ...
    getCompanyInfo(sender = null) {
      ...
      return {
        ...
        legalText: `
          ...
          DIR: ${s.address || 'Cartagena Colombia'}<br/>
          TEL: ${s.phone || ''}<br/>
          EMAIL: ${s.email || ''}<br/>
          DPTO: ${s.department || ''}<br/>
...
/* ✅ NUEVO: Información Fija en Sidebar */
.sidebar-fixed-info {
  display: flex;
  flex-direction: column;
  gap: 0.015in;
...
.fixed-text-line:first-child {
  ...
  color: #0066CC;
      ...
      .header-center {
        display: flex;
        flex-direction: column;
        gap: 0.2in;  /* ✅ AUMENTAR: de 0.03in a 0.05in (o el valor que prefieras) */
        margin: 0 0.15in;
      }
      ...
      .tables-grid {
        display: grid;
        grid-template-columns: 1in 0.50in 1fr;
        gap: 0.03in;
        border: 1px solid #000;
        padding: 0.02in;
        flex: 1;
      ...
      .door-options label { font-size: 5.5 pt; }
