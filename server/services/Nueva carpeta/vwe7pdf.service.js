...
class PDFService {
  ...
  // ✅ Renderiza guías vacías para mantener el diseño cuando hay menos de 3
  ...
  getPrintStyles() {
    return `
      * {
      ...
      /* ✅ GUÍA CON ALTURA FIJA - Mantiene diseño con 1, 2 o 3 guías */
      .guide {
        flex: 1;
        min-height: 3.15in;  /* Altura fija para cada guía */
        max-height: 3.15in;
