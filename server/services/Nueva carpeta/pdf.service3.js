              ...
              <div class="right-column">
                ...
                <div class="tables-grid">
                  <div class="property-box">
                    <div class="vertical-label">INMUEBLE</div>
                    <div class="options">
                      <label>☐ Casa</label>
                  ...
                  <div class="floor-box">
                    <div class="vertical-label">PISO</div>
                    <div class="options">
                      <label>☐ 1</label>
                      <label>☐ 2</label>
                      <label>☐ 3</label>
    ...
    return null;
        ...
        const browser = await puppeteer.launch({
          ...
          args: [
            ...
            '--js-flags=--max-old-space-size=4096'  // ✅ 4GB de memoria para JS
          ]
        });
        ...
        try {
          ...
          // ✅ Aumentar viewport para mejor renderizado
          ...
          await page.waitForSelector('.guide', { timeout: 60000 });
          ...
          await browser.close();
          console.error('❌ Error en generateGuidesPDF:', error);
  ...
  getPrintStyles() {
    return `
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      .guide-wrapper { flex: 1; display: flex; flex-direction: column; gap: 0.05in;}
