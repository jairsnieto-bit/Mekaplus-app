...
class PDFService {
  async generateGuideHTML(guide, config, settings) {
    ...
    return `
            ...
            <div class="header-section">
              ...
              <div class="header-center">
                ...
                <div class="hora-entrega">
                  ...
                  <span class="line">${guide.horaEntrega || '__________'}</span>
                </div>
              </div>
      ...
      <div class="options" style="padding: 0.01in 0;">
        <label style="display: block; margin: 0.05in 0;">☐ Casa</label>
        <label style="display: block; margin: 0.05in 0;">☐ Edificio</label>
        <label style="display: block; margin: 0.05in 0;">☐ Negocio</label>
        <label style="display: block; margin: 0.05in 0;">☐ Conjunto</label>
      </div>
                  </div>
      ...
      <div class="options" style="padding: 0.01in 0;">
        <label style="display: block; margin: 0.03in 0;">☐ 1</label>
        <label style="display: block; margin: 0.03in 0;">☐ 2</label>
        <label style="display: block; margin: 0.03in 0;">☐ 3</label>
        <label style="display: block; margin: 0.03in 0;">☐ 4</label>
        <label style="display: block; margin: 0.03in 0;">☐ +4</label>
      </div>
                  </div>
  ...
  for (let index = 0; index < guides.length; index++) {
    ...
    // ✅ LÍNEA DE CORTE DESPUÉS DEL WRAPPER (no dentro)
  ...
  getPrintStyles() {
    return `
      * { margin: 0; padding: 0; box-sizing: border-box; }
      ...
      flex-direction: column;
      /*column; gap: 0.05in;*/
      margin-bottom: 0.08in;  /* ✅ ESPACIO DESPUÉS DE CADA GUÍA */
      }
      ...
      /*.cut-line { border-top: 1px dashed #999; margin: 0.08in 0; }*/
      .guide-wrapper:last-child {
      margin-bottom: 0;  /* ✅ SIN MARGEN EN LA ÚLTIMA */
      }
        }.cut-line::after {
